...
describe('SyncManagerLevel', () => {
  ...
  //       const writeResponse = await testAgent.agent.dwnManager.sendRequest({
  //         author         : alice.did,
  //         target         : alice.did,
  ...
  //         },
  //         dataStream: new Blob([`Hello, World ${i}`])
  //       }); 
  //       expect(writeResponse.reply.status.code)
  //     }
  ...
  //     });
  //     const localDwnQueryReply = queryResponse.reply as RecordsQueryReply;
