...
import { QueryResultEntry, RecordsQueryReply, RecordsQueryReplyEntry, RecordsWriteMessage } from '@tbd54566975/dwn-sdk-js';
  ...
  describe('with Web5ManagedAgent', () => {
    ...
    describe('pull()', () => {
      ...
      it('synchronizes records with data larger than the `encodedData` limit within the `RecordsQuery` response', async () => {
        ...
        const entry = localReply2.entries![0] as QueryResultEntry;
