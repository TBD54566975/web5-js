...
describe('AWS KMS Utils', () => {
    ...
    describe('createKeyAlias()', () => {
        it('creates a new alias and associates it with a target AWS KMS Key ID', () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
    ...
    describe('getKeySpec()', () => {
        it(`throws an error if 'KeyMetadata' is not returned in the AWS KMS response`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Test the method.
            try {
                yield getKeySpec({ keyUri, kmsClient: kmsClientStub });
        ...
        it(`throws an error if 'KeyMetadata.KeySpec' is not returned in the AWS KMS response`, () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
            const keyUri = 'urn:jwk:U01_M3_A9vMLOWixG-rlfC-_f3LLdurttn7c7d3_upU';
            const kmsClientStub = sinon.createStubInstance(KMSClient);
            kmsClientStub.send.withArgs(sinon.match.instanceOf(DescribeKeyCommand)).resolves({
