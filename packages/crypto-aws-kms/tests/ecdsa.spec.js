...
describe('EcdsaAlgorithm', () => {
    ...
    beforeEach(() => {
        ...
        ecdsa = new EcdsaAlgorithm({ crypto, kmsClient: kmsClientStub });
    });
    afterEach(() => {
        sinon.restore();
    });
    describe('generateKey()', () => {
        it(`throws an error if 'KeyMetadata' is not returned in the AWS KMS response`, () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
            kmsClientStub.send.withArgs(sinon.match.instanceOf(CreateKeyCommand)).resolves({});
            // Test the method.
            try {
                yield ecdsa.generateKey({ algorithm: 'ES256K' });
        ...
        it(`throws an error if 'KeyMetadata.KeyId' is not returned in the AWS KMS response`, () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
            kmsClientStub.send.withArgs(sinon.match.instanceOf(CreateKeyCommand)).resolves({
                '$metadata': {},
                KeyMetadata: {}
    ...
    describe('sign()', () => {
        it('generates signatures that can be verified with Secp256k1.verify()', () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
        ...
        it('throws an error if an unsupported algorithm is specified', () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
            ...
            try {
                ...
                yield ecdsa.sign({ keyUri, algorithm, data });
                expect.fail('Expected an error to be thrown.');
            }
            catch (error) {
                // Validate the result.
        ...
        it('throws an error if the signature is not returned in the AWS KMS response', () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
            const keyUri = 'urn:jwk:U01_M3_A9vMLOWixG-rlfC-_f3LLdurttn7c7d3_upU';
    ...
    describe('verify()', () => {
        it('throws an error if an invalid key type is specified', () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
            ...
            // Test the method.
            try {
                yield ecdsa.verify({ key: ed25519PublicKey, signature, data });
                expect.fail('Expected an error to be thrown.');
            }
            catch (error) {
                // Validate the result.
        ...
        it('throws an error if the curve of the EC public key specified is unsupported', () => __awaiter(void 0, void 0, void 0, function* () {
            // Setup.
            const unsupportedEcPublicKey = {
                kty: 'EC',
            ...
            // Test the method.
            try {
                yield ecdsa.verify({ key: unsupportedEcPublicKey, signature, data });
                expect.fail('Expected an error to be thrown.');
            }
            catch (error) {
                // Validate the result.
