...
import { KeySpec, KMSClient, GetPublicKeyCommand, } from '@aws-sdk/client-kms';
...
export class AwsKmsCrypto {
    constructor(params) {
        ...
        this._kmsClient = (_a = params === null || params === void 0 ? void 0 : params.kmsClient) !== null && _a !== void 0 ? _a : new KMSClient();
    }
    /**
    ...
    generateKey({ algorithm }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const keyUri = yield keyGenerator.generateKey({ algorithm });
            return keyUri;
        });
    }
    /**
    ...
    getPublicKey({ keyUri }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this._kmsClient.send(new GetPublicKeyCommand({
                KeyId: awsKeyId
            }));
    ...
    sign({ keyUri, data }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const keySpec = yield getKeySpec({ keyUri, kmsClient: this._kmsClient });
            ...
            // Sign the data.
            const signature = yield signer.sign({ algorithm, keyUri, data });
            return signature;
        });
    }
    /**
     ...
     */
    getAlgorithmName({ key, keySpec }) {
        const algProperty = key === null || key === void 0 ? void 0 : key.alg;
