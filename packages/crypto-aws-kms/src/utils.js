...
import { CreateAliasCommand, DescribeKeyCommand } from '@aws-sdk/client-kms';
/**
...
export function createKeyAlias({ alias, awsKeyId, kmsClient }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield kmsClient.send(new CreateAliasCommand({
...
export function getKeySpec({ keyUri, kmsClient }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield kmsClient.send(new DescribeKeyCommand({
            KeyId: awsKeyId
        }));
        if (!((_a = response.KeyMetadata) === null || _a === void 0 ? void 0 : _a.KeySpec)) {
