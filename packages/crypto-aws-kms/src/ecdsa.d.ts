import type { Signer, CryptoApi, KeyGenerator, KeyIdentifier, KmsSignParams, KmsVerifyParams, KmsGenerateKeyParams } from '@web5/crypto';
...
export declare class EcdsaAlgorithm implements KeyGenerator<EcdsaGenerateKeyParams, KeyIdentifier>, Signer<KmsSignParams, KmsVerifyParams> {
    /**
