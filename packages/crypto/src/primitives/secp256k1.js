...
export class Secp256k1 {
    ...
    static bytesToPrivateKey({ privateKeyBytes }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const points = yield Secp256k1.getCurvePoints({ keyBytes: privateKeyBytes });
    ...
    static bytesToPublicKey({ publicKeyBytes }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const points = yield Secp256k1.getCurvePoints({ keyBytes: publicKeyBytes });
     ...
     *          elliptic curve.
     */
    static getCurvePoints({ keyBytes }) {
        return __awaiter(this, void 0, void 0, function* () {
