...
import { XChaCha20Poly1305 } from '../crypto-primitives/index.js';
import { BaseXChaCha20Poly1305Algorithm, CryptoKey } from '../algorithms-api/index.js';

export class XChaCha20Poly1305Algorithm extends BaseXChaCha20Poly1305Algorithm {
  public async decrypt(options: {
    algorithm: Web5Crypto.XChaCha20Poly1305Options,
