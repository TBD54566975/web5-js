...
import { isPublicJwk, isPrivateJwk, isEcPublicJwk, isEcPrivateJwk, isOkpPublicJwk, isOctPrivateJwk, isOkpPrivateJwk, computeJwkThumbprint, } from '../../src/jose/jwk.js';
    ...
    describe('computeJwkThumbprint()', () => {
        it('passes all test vectors', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const vector of jwkToThumbprintTestVectors) {
                jwkThumbprint = yield computeJwkThumbprint({ jwk: vector.input });
                expect(jwkThumbprint).to.equal(vector.output);
            }
        }));
        it('throws an error if unsupported key type has been passed', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(
            // @ts-expect-error because an invalid key type is being intentionally passed.
            computeJwkThumbprint({ jwk: { crv: 'X25519', kty: 'unsupported' } })).to.eventually.be.rejectedWith(Error, `Unsupported key type: unsupported`);
        }));
    });
