...
describe('AesGcmAlgorithm', () => {
    ...
    before(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        dataEncryptionKey = yield aesGcm.generateKey({ algorithm: 'A128GCM' });
    }));
    describe('encrypt()', () => {
    ...
    describe('generateKey()', () => {
        it('returns a private key in JWK format', () => __awaiter(void 0, void 0, void 0, function* () {
            const privateKey = yield aesGcm.generateKey({ algorithm: 'A128GCM' });
        ...
        it(`supports 'A128GCM', 'A192GCM', and 'A256GCM' algorithms`, () => __awaiter(void 0, void 0, void 0, function* () {
            const algorithms = ['A128GCM', 'A192GCM', 'A256GCM'];
            for (const algorithm of algorithms) {
                const privateKey = yield aesGcm.generateKey({ algorithm });
