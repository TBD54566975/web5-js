...
describe('XChaCha20', () => {
    ...
    describe('decrypt()', () => {
        it('returns Uint8Array plaintext with length matching input', () => __awaiter(void 0, void 0, void 0, function* () {
            const privateKey = yield XChaCha20.generateKey();
            const plaintext = yield XChaCha20.decrypt({
        ...
        it('passes test vectors', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const ciphertext = yield XChaCha20.decrypt({
                data: input.data,
                key: input.key,
                nonce: input.nonce
            });
    ...
    describe('encrypt()', () => {
        it('returns Uint8Array ciphertext with length matching input', () => __awaiter(void 0, void 0, void 0, function* () {
            const privateKey = yield XChaCha20.generateKey();
            const ciphertext = yield XChaCha20.encrypt({
                data: new Uint8Array(10),
                key: privateKey,
                nonce: new Uint8Array(24)
            });
    ...
    describe('privateKeyToBytes()', () => {
        it('returns a private key as a byte array', () => __awaiter(void 0, void 0, void 0, function* () {
            const privateKey = yield XChaCha20.generateKey();
            const privateKeyBytes = yield XChaCha20.privateKeyToBytes({ privateKey });
        ...
        it('throws an error when provided an asymmetric public key', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(XChaCha20.privateKeyToBytes({ privateKey: publicKey })).to.eventually.be.rejectedWith(Error, 'provided key is not a valid oct private key');
        }));
    });
});
//# sourceMappingURL=xchacha20.spec.js.map