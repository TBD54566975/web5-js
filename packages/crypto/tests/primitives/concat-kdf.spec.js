...
describe('ConcatKdf', () => {
    describe('deriveKey()', () => {
        it('matches RFC 7518 ECDH-ES key agreement computation example', () => __awaiter(void 0, void 0, void 0, function* () {
            // Test vector 1
            ...
            const derivedKeyingMaterial = yield ConcatKdf.deriveKey(input);
        ...
        it('accepts other info as String and TypedArray', () => __awaiter(void 0, void 0, void 0, function* () {
            const inputBase = {
            ...
            // String input.
            const inputString = Object.assign(Object.assign({}, inputBase), { otherInfo: {
                    algorithmId: 'A128GCM',
                    partyUInfo: 'Alice',
                    partyVInfo: 'Bob',
                    suppPubInfo: 128
                } });
            let derivedKeyingMaterial = yield ConcatKdf.deriveKey(inputString);
            expect(derivedKeyingMaterial).to.be.an('Uint8Array');
            expect(derivedKeyingMaterial.byteLength).to.equal(32);
            // TypedArray input.
            const inputTypedArray = Object.assign(Object.assign({}, inputBase), { otherInfo: {
                    algorithmId: 'A128GCM',
                    partyUInfo: Convert.string('Alice').toUint8Array(),
                    partyVInfo: Convert.string('Bob').toUint8Array(),
                    suppPubInfo: 128
                } });
            derivedKeyingMaterial = yield ConcatKdf.deriveKey(inputTypedArray);
            expect(derivedKeyingMaterial).to.be.an('Uint8Array');
            expect(derivedKeyingMaterial.byteLength).to.equal(32);
        }));
        it('throws error if multi-round Concat KDF attempted', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(
            // @ts-expect-error because only parameters needed to trigger the error are specified.
            ConcatKdf.deriveKey({ keyDataLen: 512 })).to.eventually.be.rejectedWith(Error, 'rounds not supported');
        }));
        it('throws an error if suppPubInfo is not a Number', () => __awaiter(void 0, void 0, void 0, function* () {
            yield expect(ConcatKdf.deriveKey({
                sharedSecret: new Uint8Array([1, 2, 3]),
                keyDataLen: 128,
                otherInfo: {
                    algorithmId: 'A128GCM',
...
//# sourceMappingURL=concat-kdf.spec.js.map