...
import { ManagedIdentity, TestManagedAgent } from '@web5/agent';
...
describe('Record', () => {
  ...
  //   const recordEncryptionKeyId = typeof didDwnService!.serviceEndpoint !== 'string' ? didDwnService!.serviceEndpoint!.encryptionKeys![0] : undefined;
  ...
  //     expect(recordJson.dateModified).to.equal(recordsWrite.message.descriptor.messageTimestamp);
