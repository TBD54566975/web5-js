 ...
 * });
 */
export const chaiUrl = function (chai, utils) {
    ...
    function isValidUrl() {
        ...
        this.assert(isUrl, 'expected #{this} to be a valid URL', 'expected #{this} not to be a valid URL');
    }
...
//# sourceMappingURL=chai-plugins.js.map