...
describe('Stream', () => {
    describe('consumeToArrayBuffer()', () => {
        it('consumes a ReadableStream and returns an ArrayBuffer', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield Stream.consumeToArrayBuffer({ readableStream });
        ...
        it('throws an error for a stream that errors', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                yield Stream.consumeToArrayBuffer({ readableStream });
    ...
    describe('consumeToBlob()', () => {
        it('consumes a ReadableStream and returns a Blob', () => __awaiter(void 0, void 0, void 0, function* () {
            const inputBytes = new Uint8Array([1, 2, 3, 4, 5]);
            const readableStream = new ReadableStream({
                start(controller) {
                    controller.enqueue(inputBytes);
            ...
            const result = yield Stream.consumeToBlob({ readableStream });
            expect(result).to.be.an.instanceof(Blob);
            expect(result.size).to.equal(inputBytes.length);
            // Read the blob to verify its content
            const arrayBuffer = yield result.arrayBuffer();
        ...
        it('consumes a large ReadableStream and returns the expected blob size', () => __awaiter(void 0, void 0, void 0, function* () {
            const oneMegabyte = new Uint8Array(1024 * 1024).map((_, i) => i % 256);
            const readableStream = new ReadableStream({
                start(controller) {
                    controller.enqueue(oneMegabyte);
        ...
        it('consumes a ReadableStream containing a string and returns the correct Blob', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const blob = yield Stream.consumeToBlob({ readableStream });
        ...
        it('throws an error for a stream that errors', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                yield Stream.consumeToBlob({ readableStream });
                expect.fail('Should have thrown an error');
            }
            catch (err) {
                expect(err).to.equal(error);
    ...
    describe('consumeToBytes()', () => {
        it('consumes a ReadableStream and returns a Uint8Array', () => __awaiter(void 0, void 0, void 0, function* () {
            const inputBytes = new Uint8Array([1, 2, 3, 4, 5]);
            const readableStream = new ReadableStream({
                start(controller) {
                    controller.enqueue(inputBytes);
            ...
            const result = yield Stream.consumeToBytes({ readableStream });
        ...
        it('throws an error for a stream that errors', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                yield Stream.consumeToBytes({ readableStream });
                expect.fail('Should have thrown an error');
            }
            catch (err) {
                expect(err).to.equal(error);
    ...
    describe('consumeToJson()', () => {
        it('consumes a ReadableStream containing JSON and returns a JavaScript object', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield Stream.consumeToJson({ readableStream });
        ...
        it('throws an error for a stream containing invalid JSON', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                yield Stream.consumeToJson({ readableStream });
                expect.fail('Should have thrown an error');
            }
            catch (err) {
    ...
    describe('consumeToText', () => {
        it('consumes a ReadableStream containing text and returns a string', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const result = yield Stream.consumeToText({ readableStream });
        ...
        it('throws an error for a stream that errors', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                yield Stream.consumeToText({ readableStream });
                expect.fail('Should have thrown an error');
            }
            catch (err) {
                expect(err).to.equal(error);
    ...
    describe('generateByteStream()', function () {
        it('generates a stream with the specified length and fill value', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const streamByteLength = 100;
                const fillValue = 43;
                const stream = Stream.generateByteStream({ streamLength: streamByteLength, fillValue });
                // Read data from the stream.
                const consumedBytes = yield Stream.consumeToBytes({ readableStream: stream });
        ...
        it('generates a stream with the specified chunk length', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const streamByteLength = 100;
                ...
                while (true) {
                    ...
                    firstChunkLength !== null && firstChunkLength !== void 0 ? firstChunkLength : (firstChunkLength = value.length);
                    chunkCount++;
                }
                // Check the length of the received bytes.
        ...
        it('handles stream lengths that are evenly divisible by chunk length', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const streamByteLength = 100;
                const chunkLength = 10;
        ...
        it('handles stream lengths that are not evenly divisible by chunk length', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const streamByteLength = 100;
        ...
        it('generates a stream with chunks having random bytes within a specified range', () => __awaiter(this, void 0, void 0, function* () {
            const streamLength = 100;
            const chunkLength = 10;
            const fillValueRange = [50, 60]; // Range for random values
        ...
        it('generates an indefinite stream when streamLength is not provided', () => __awaiter(this, void 0, void 0, function* () {
            const chunkLength = 1;
            const fillValue = 0;
            const maxIterations = 10000; // Limit iterations to avoid an infinite loop in the test.
    ...
    describe('isReadable()', () => {
        ...
        it('returns false for a consumed ReadableStream', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = new ReadableStream({
                start(controller) {
        ...
        it('returns false for a closed ReadableStream', () => __awaiter(void 0, void 0, void 0, function* () {
            const stream = new ReadableStream({
                start(controller) {
                    controller.close();
                }
