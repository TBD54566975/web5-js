...
describe('Convert', () => {
    ...
    describe('from: AsyncIterable', () => {
        let asyncIterableBytes;
        let asyncIterableJson;
        let asyncIterableString;
        // Create a generator function that yields two Uint8Array chunks.
        function generateBytesData() {
            return __asyncGenerator(this, arguments, function* generateBytesData_1() {
                yield yield __await(new Uint8Array([1, 2, 3]));
                yield yield __await(new Uint8Array([4, 5, 6]));
            });
        }
        // Create a generator function that yields parts of a JSON string.
        function generateJsonData() {
            return __asyncGenerator(this, arguments, function* generateJsonData_1() {
        ...
        function generateStringData() {
            return __asyncGenerator(this, arguments, function* generateStringData_1() {
                yield yield __await(textEncoder.encode('Hello, '));
                yield yield __await(textEncoder.encode('world!'));
            });
        }
        beforeEach(() => {
        ...
        it('to: ArrayBuffer', () => __awaiter(void 0, void 0, void 0, function* () {
            const output = yield Convert.asyncIterable(asyncIterableBytes).toArrayBufferAsync();
        ...
        it('to: Blob', () => __awaiter(void 0, void 0, void 0, function* () {
            const output = yield Convert.asyncIterable(asyncIterableBytes).toBlobAsync();
            ...
            const arrayBuffer = yield output.arrayBuffer();
        ...
        it('to: Object', () => __awaiter(void 0, void 0, void 0, function* () {
            const output = yield Convert.asyncIterable(asyncIterableJson).toObjectAsync();
        ...
        it('to: String', () => __awaiter(void 0, void 0, void 0, function* () {
            const output = yield Convert.asyncIterable(asyncIterableString).toStringAsync();
            // The expected result is the concatenated string
            const expected = 'Hello, world!';
            // Compare the result with the expected string
            expect(output).to.equal(expected);
        }));
        it('to: Uint8Array', () => __awaiter(void 0, void 0, void 0, function* () {
            const output = yield Convert.asyncIterable(asyncIterableBytes).toUint8ArrayAsync();
            // The expected result is a Uint8Array that concatenates all chunks
            const expected = new Uint8Array([1, 2, 3, 4, 5, 6]);
            // Compare the result with the expected Uint8Array
            expect(output).to.deep.equal(expected);
        }));
        it('throws an error if input is not AsyncIterable', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
    ...
    describe('Unsupported conversions', () => {
        ...
        it('toArrayBufferAsync() throw an error', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                yield unsupported.toArrayBufferAsync();
                expect.fail('Should have thrown an error for incorrect type');
            }
            catch (error) {
                expect(error).to.be.instanceOf(TypeError);
        ...
        it('toBlobAsync() throw an error', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                yield unsupported.toBlobAsync();
                expect.fail('Should have thrown an error for incorrect type');
            }
            catch (error) {
                expect(error).to.be.instanceOf(TypeError);
        ...
        it('toObjectAsync() throw an error', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                yield unsupported.toObjectAsync();
                expect.fail('Should have thrown an error for incorrect type');
            }
            catch (error) {
                expect(error).to.be.instanceOf(TypeError);
        ...
        it('toStringAsync() throw an error', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                yield unsupported.toStringAsync();
                expect.fail('Should have thrown an error for incorrect type');
            }
            catch (error) {
                expect(error).to.be.instanceOf(TypeError);
        ...
        it('toUint8ArrayAsync() throw an error', () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                yield unsupported.toUint8ArrayAsync();
                expect.fail('Should have thrown an error for incorrect type');
            }
            catch (error) {
                expect(error).to.be.instanceOf(TypeError);
